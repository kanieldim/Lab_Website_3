...
app.get('/team_stats', function(req, res) {
  var retrieveGames = 'select visitor_name, home_score, visitor_score, game_date, players from football_games';
...
app.get('/player_info/select_player', function(req, res) {
  ...
  var queryID = 'select id, name from football_players;';
  var queryInfo = 'select year, major, passing_yards, rushing_yards, receiving_yards, img_src from football_players where football_players.id = ' + IDplayer + ';';
  var queryGame = 'select count(*) from football_players INNER JOIN football_games ON football_players.id = ANY(football_games.players) WHERE football_players.id = ' + IDplayer + ';';
  db.task('get-everything', task => {
      return task.batch([
          task.any(queryID),
          task.any(queryInfo),
